...
| Kopfzeile der Anwendung       | dieselbe Wortmarke, 26 px — sie ersetzt den Organisationsnamen (ANN-021)                                                |
| Akzentfarbe                   | Hauptfarbe `#004429`; Hover trägt Tiefgrün `#042c1b` (ANN-020)                                                          |
