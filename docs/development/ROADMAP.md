...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Die Schritte 1
  ...
  zweimal umzubauen ist teurer als einmal. **Die Schritte 1 und 2 sind am
  ...
  §21) — **Schritt 3 (ADR-006 neue Fassung) ist damit frei.** Er **liegt seit
  dem 2026-09-20 als Vorschlag vor**
  ([ADR-006](../adr/ADR-006-medical-device-boundary.md) Fassung 3, die drei
  Feature-Verbote) und wartet auf die Annahme — Schritt 4 beginnt erst danach.
