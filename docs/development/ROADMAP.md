...
Version 5.25 · Stand 2026-09-20 · **in Kraft**
...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Die Schritte 1
  ...
  der Zweckbestimmung samt den drei Verboten in §17. **Damit ist Schritt 6
  frei** — die Roadmap neu schneiden; ein Loop, der Code baut, beginnt
  weiterhin erst, wenn der ADR über ihm steht.
- **Was Schritt 6 aus ADR-009 Fassung 2 zu schneiden hat**, sobald die
  Reihenfolge neu gelegt wird: der dritte Schlüsselteil
  am Nummernkreis (Bereich neben Organisation und Jahr), der Leistungsbereich
  als dritter Schlüssel der Rechnungsbündelung, der § 14c-Riegel mit seinem
  Pflicht-Testfall und die Auswertung „Einnahmen je Leistungsart". **Keine
  eigene Zeile in Etappe 1** — die Reihenfolge bleibt bis Schritt 6
  unverändert. Der fehlende Befreiungsgrund auf der Rechnung ist davon der
  einzige Punkt, der schon Gebautes korrigiert: **BEF-019**.
