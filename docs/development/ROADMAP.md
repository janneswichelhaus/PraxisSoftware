...
Version 5.24 · Stand 2026-09-20 · **in Kraft**
...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Die Schritte 1
  ...
  unberührt) — **Schritt 5 (`PROJECT_PRINCIPLES.md` neue Version: §1, §4,
  Zweckbestimmung, §14) ist damit frei.** Er hat Rang 1 und kommt zuletzt; ein
  Loop, der Code baut, beginnt weiterhin erst, wenn der ADR über ihm steht.
...
- **`MDR_REVIEW_REQUIRED` hat bis heute keine Codestelle** (ADR-006 Punkt 6 und
  ...
  sein. Gehört in eine eigene Sitzung, frühestens nach E18 Schritt 5; kein Loop
  wartet darauf.
