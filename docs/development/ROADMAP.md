...
- **MFA vertagt (Jannes, 2026-09-11).** Die **Pflicht** zum zweiten Faktor für
  ...
  ANN-026 hält den Stand und den Weg dorthin fest. Damit ist der Punkt **kein
...
| R10 | Mobile Endgeräte ohne Richtlinie (Verlust, Sperre, MFA, Kartenverlauf)          | mittel   | hoch      | TOM ohne Abschnitt Endgeräte               | Endgeräte-Richtlinie in G14 (mit Google-Konto und Kartenverlauf); „Alle Sitzungen beenden" **gebaut** (STAFF-004); MFA einrichtbar, Pflicht vertagt bis zur Domain (ANN-026) | beide         |
...
| **CAL-EPIC-003b** | Eine Verordnung wird in einer Minute zu einer Terminserie          | **CAL-007** Serie aus der Verordnung: Anzahl aus dem Kontingent, fester Rhythmus, Konfliktprüfung je Termin inline, Einzelabweichung · **CAL-010a** Terminfenster nach `PROJECT_PRINCIPLES.md` §8.1 (entschieden 2026-09-08): 60 Minuten einschließlich Dokumentation, Vorbelegung im Formular **und** serverseitige Durchsetzung in `create_appointment`/`update_appointment` — eine Vorbelegung allein erfüllt §8.1 nicht; geprüft wird nur ein **neu gesetztes** Zeitfenster, Bestandstermine bleiben gültig und rein organisatorisch bearbeitbar (dieselbe Abgrenzung wie beim Raster, CAL-005); Beginn weiter frei im 5-Minuten-Raster; Testfälle in `pnpm test:db` für beide Schreibpfade und für den Bestandstermin · **CAL-010b** Fahrpuffer als Praxisregel: Mindestabstand zwischen Hausbesuchen an verschiedenen Adressen; früheste Folgezeit ist der erste Rasterpunkt auf oder nach Ende plus Fahrzeit — **aufrunden, nie abrunden** (Beispiel 09:05–10:05 plus 12 Minuten Fahrt ergibt 10:20, nicht 10:15; als Testfall), deterministisch nach §6.2. **Herkunft der Fahrzeit sowie Warnung oder Sperre sind offen (E12)**; `IDEA-PRX-002` ist dazu nur der Vorschlag, keine Festlegung. Fahrzeiten aus dem Dienst kommen mit MAP-006, ersetzen oder ergänzen CAL-010b dann · Terminzettel als Druckansicht (`IDEA-PRX-006`)                                                                                                                                                                                                                                                                                                                                                                                                                                       | VER-001, CAL-EPIC-003a, UI-000 (Druck); §8.1 für CAL-010a         | Antwort auf E12 (blockiert nichts) |
