...
Version 3.1 · Stand 2026-09-11 · **in Kraft**
...
- **Voraussetzung: ADR-018 liegt seit dem 2026-09-11 vor** und wartet auf
  Jannes' Bestätigung — sieben Fragen am Ende von
  [`ADR-018`](../adr/ADR-018-appointment-states.md), je eine Zeile genügt. Die
  wichtigste ist die Umbenennung `scheduled` → `confirmed`: Sie gehört in
  CAL-008 und wird teurer, je länger sie wartet. **Antwortet Jannes nicht vor
  dem Loop**, gilt `PROJECT_PRINCIPLES.md` §15.1 — der Zustandsautomat ist
  kein Hard-Stop-Thema; der Loop folgt dann dem ADR in seiner vorgeschlagenen
  Fassung und registriert die offenen Punkte als Annahme.
- **Nach der Bestätigung** ist `PROJECT_PRINCIPLES.md` §8 nachzuziehen (§21,
  eigener Commit) und Punkt D in `OPEN_DECISIONS.md` zu schließen. Beides
  gehört **nicht** in den Code-Loop, sondern in die Antwort darauf.
...
| **D → ADR-018**              | Terminzustände: Übergänge, Auslöser, Migration; „angefragt"/„vorgemerkt" definiert, nicht gebaut                                                   | Claude schreibt, Jannes bestätigt   | CAL-EPIC-003a                | Sep 2026                            | **geschrieben 2026-09-11**, sieben Bestätigungsfragen offen |
...
| ADR-018 Terminzustände (Docs)                            | fertig | 2026-09-11     | wartet auf die Bestätigung durch Jannes                             | —             |
