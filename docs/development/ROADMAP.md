...
| **B14 PDF-Weg**              | Rechnungs-PDF: Browser-Druck, Bibliothek im Browser oder serverseitige Funktion — **Optionen liegen seit 2026-09-19 vor** (`docs/decisions/rechnungs-pdf-optionen.md`, Empfehlung serverseitig, bis dahin Browser-Druck); Druckansichten sind entschieden | Jannes entscheidet                  | ABR-EPIC-002b                | Nov 2026                            | bewusst offen; Tendenz serverseitig |
...
Auskunft des Lizenzgebers (B8), der PDF-Weg (B14, Optionen liegen vor),
