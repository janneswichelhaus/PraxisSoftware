...
Version 5.5 · Stand 2026-09-15 · **in Kraft**
...
- **CAL-EPIC-004 eingeordnet (2026-09-16).** Jannes hat die Reihenfolge an
  ...
  **CAL-018 → CAL-EPIC-004a → CAL-EPIC-004b → UX-013 → GRD-001 →
  VER-EPIC-002 → CAL-EPIC-004c → ABR-EPIC-001** (GRD-001 seit dem Abschluss
