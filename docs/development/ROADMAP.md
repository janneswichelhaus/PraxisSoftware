...
| Marke Own Motion als Dateien und Regel (Docs)           | fertig | 2026-09-10     | `eb5c234`, Branch `claude/praxissoftware-product-decisions-pl2t88`  | —             |
| MARKE-001 Marke in der Anwendung                        | fertig | 2026-09-10     | `577ecd6`, `fb5cee0`, `7486c95`, Branch `claude/hopeful-darwin-4ko8gy` |               |
...
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.7     | 2026-09-10 | **MARKE-001 — die Anwendung trägt die Marke Own Motion** (auf ausdrücklichen Auftrag, **nicht** aus der Roadmap): Favicon und App-Symbol über byte-gleiche Kopien in `public/marke/` (`src/marke.test.ts` hält die Gleichheit fest, `marke/` bleibt einzige Quelle); `--color-accent` auf die Hauptfarbe `#004429`, Hover auf das Tiefgrün `#042c1b` der Marke (ANN-020) — dunkler statt heller, weil `accent-hover` überwiegend Textfarbe ist; Wortmarke in Kopfzeile und Anmeldemaske, Seitentitel „Own Motion", der Organisationsname entfällt aus der Kopfzeile (ANN-021). Kontrastgate erweitert statt abgeschwächt. Abnahmeschritt MARKE-001 in `docs/abnahme/etappe-1-kernprozess.md`. Offen bleiben die drei Befunde aus `marke/README.md` (Favicon bei 16 px unlesbar, App-Symbole nur als PNG, C2PA-Metadaten) sowie Schrift und Radien. **Reihenfolge unverändert — UX-EPIC-001 bleibt der nächste Loop.** |
