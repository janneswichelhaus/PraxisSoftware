...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Der nächste
  ...
  teurer als einmal. **Schritt 1 liegt seit dem 2026-09-20 als
  [ADR-021](../adr/ADR-021-service-areas-and-legal-relationships.md) vor,
  Status vorgeschlagen** — Schritt 2 (ADR-022 Terminkontext) beginnt erst nach
  seiner Annahme.
