...
- **CAL-EPIC-004 eingeordnet (2026-09-16).** Jannes hat die Reihenfolge an
  ...
  **~~CAL-018~~ (fertig 2026-09-16) → CAL-EPIC-004a → CAL-EPIC-004b → UX-013
  → GRD-001 → VER-EPIC-002 → CAL-EPIC-004c → ABR-EPIC-001** (GRD-001 seit dem Abschluss
...
>
> **Was daraus folgt, ist noch nicht geplant, und nichts davon ist gebaut.**
> Die Umsetzung braucht zuerst Antworten; sie gehören in einen eigenen
> Planungsschritt und nicht in den nächsten Feature-Loop:
>
...
>
> Bis diese Fragen beantwortet sind, bleibt die Reihenfolge der Etappe 1
> unverändert. B5, B9 und B11 sind die Vorbedingungen, die zuerst gebraucht
> werden.
