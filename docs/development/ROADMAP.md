...
Version 5.22 · Stand 2026-09-20 · **in Kraft**
...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Die Schritte 1
  ...
  zweimal umzubauen ist teurer als einmal. **Die Schritte 1 bis 3 sind am
  ...
  Feature-Verbote — §21 nennt keine Fassung und blieb unberührt) — **Schritt 4
  (ADR-009 neue Fassung: Steuerkennzeichen am Posten, getrennte Nummernkreise)
  ist damit frei.** Er **liegt seit dem 2026-09-20 als Vorschlag vor**
  ([ADR-009](../adr/ADR-009-private-billing-model.md) Fassung 2, Punkte 15 bis
  20) und wartet auf die Annahme — Schritt 5 beginnt erst danach.
- **Was Schritt 6 aus ADR-009 Fassung 2 zu schneiden hat**, sobald sie
  angenommen ist und die Reihenfolge neu gelegt wird: der dritte Schlüsselteil
