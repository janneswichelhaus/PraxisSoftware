...
- **E18 kommt nach ABR-EPIC-003 (entschieden 2026-09-19).** Der nächste
  ...
  `PROJECT_PRINCIPLES.md` 0.12.1 §21); **Schritt 2 liegt seit dem 2026-09-20 als
  Vorschlag vor** ([ADR-022](../adr/ADR-022-appointment-context-and-training-basis.md))
  und wartet auf die Annahme — Schritt 3 beginnt erst danach.
