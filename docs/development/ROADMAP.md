...
- **Docs, Jannes (Rang 1/2):** Die Vermerke „bis ROL-EPIC-001 gilt der gebaute
  Stand" in `PROJECT_PRINCIPLES.md` §4.3, ADR-004, ADR-016, ADR-017 Punkt 12
  und `OPEN_DECISIONS.md` E15 auf „umgesetzt 2026-09-15" stellen.
- **Befund-Loop vor der ersten echten Datei:** BEF-004 — Dateizugriff am
  Auditeintrag vorbei (Zweitreview zu ROL-EPIC-001); eigener Loop nach
  ADR-013 Punkt 9 Nr. 8, Vorgabe in `BEFUNDE.md`.
