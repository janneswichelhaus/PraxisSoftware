...
- **CAL-EPIC-004 eingeordnet (2026-09-16).** Jannes hat die Reihenfolge an
  ...
  **CAL-018 → CAL-EPIC-004a → CAL-EPIC-004b → UX-013 → VER-EPIC-002 →
  CAL-EPIC-004c → ABR-EPIC-001.** Begründung: 004a schließt zuerst die Lücke
  ...
  auf der freien Länge auf. 004c braucht **E16** und arbeitet an denselben
  Zahlen wie VER-EPIC-002, läuft also danach. UX-013 hängt an nichts und kann
  vorgezogen werden, wenn ein Loop Luft hat.
