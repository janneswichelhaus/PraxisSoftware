...
| Zahlungen                | `/abrechnung/zahlungen`                | eigene Anforderung: Eingänge, Teilzahlungen und Rückzahlungen (ABR-EPIC-003). **Der Rest des Bereichs ist keine Vorschau mehr**: Leistungen und Katalog seit ABR-EPIC-001, Rechnungen, Empfänger und Praxis-Stammdaten seit ABR-EPIC-002a — sie stehen in Abschnitt 1; `trennung.test.ts` nennt die sechs echten Dateien namentlich als Ausnahme |
