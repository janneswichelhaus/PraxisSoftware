...
| Abrechnung (Rest)        | `/abrechnung`, `/abrechnung/zahlungen` | eigene Anforderung: Rechnungen und Zahlungen. **Leistungen und Katalog sind seit ABR-EPIC-001 keine Vorschau mehr** und stehen in Abschnitt 1; `trennung.test.ts` nennt die drei echten Dateien namentlich als Ausnahme |
