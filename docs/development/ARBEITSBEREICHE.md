...
| Auditansicht                            | `/praxis/sicherheit/audit`                              | nur `owner`                                      |
...
| Teamverzeichnis          | `/team/verzeichnis`           | Kontakte, Rolle, Kategorie, Erfahrungsstufe                                                                                                                   |
| Personalakte             | `/betrieb/personal`           | Eintritt, Urlaubsanspruch, Resturlaub, Notfallkontakt, Notiz                                                                                                  |
