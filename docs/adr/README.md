...
| [ADR-019](ADR-019-map-service.md) | Kartendienst: In-App-Karte, Fahrradrouting, Fahrzeiten, Navigations-Handoff | **Angenommen (2026-09-22), Fassung 3** — Fassung 3 löst Punkt 6 ab und ergänzt Abschnitt F (Führung auf dem Gerät, Bedingungen aus §20.1); PTV Developer als Kandidat, produktive Freigabe am Vertrags-/§203-/DSFA-Gate |
