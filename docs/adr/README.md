...
| [ADR-017](ADR-017-file-storage.md) | Dateiablage: Ort, Zugriff, kurzlebige Verweise, Aufbewahrung, Virenprüfung | Angenommen (bestätigt 2026-09-12); produktive Ablage zusätzlich an OPS-001 und OPS-003 gebunden; **Fassung 2 (2026-09-26)**: Fotos von Patient:innen (Abschnitt G) — Einwilligung als Grundlage, Klasse `patientenfoto` mit zwölf Monaten Frist, Aufnahme nur im Kameradialog, keine Aufnahmemetadaten, Anzeige ohne Download; echte Fotos erst nach B2 und DSFA |
