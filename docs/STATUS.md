...
- **Ungemergte Branches — bitte sichten, gelöscht wird nur mit deinem OK.** Fünf stammen aus der Zeit vor der Neufassung der `main`-Historie, ihr Inhalt steht auf `main` (geprüft an ANN-055, BEF-012 bis 016, Chronik R2): `claude/befunde-kalender-2026-09-18`, `claude/issue-42-status-fv319v`, `claude/konsolidierung-r2`, `claude/nice-goldberg-kcnct0` — Empfehlung **löschen**. Zwei tragen nur die Arbeitsdatei `R3-UEBERGABE.md` der erledigten Runde R3: `claude/r3-analyse`, `claude/r3-code-review-hardening-c22b8f` — **löschen**. Einer hat Inhalt, der nicht auf `main` ist: `claude/hopeful-mendel-ib440i` (Idee „Patientennummer", als `IDEA-QSN-011` verworfen) — Empfehlung: mit `/idee` als verworfen nachtragen, dann löschen.
