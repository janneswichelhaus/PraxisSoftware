...
4. **GRD-001** — Behandlungsgrundlage nach
...
- **GitHub-Actions-Minuten des Monats aufgebraucht** (2026-09-16): kein CI-Lauf
  ...
  auf `claude/nice-goldberg-kcnct0`, nicht auf `main`** — dieser Stand,
  ADR-020 und CAL-EPIC-004 liegen nur dort.
...
entschieden, ADR-020 ist angenommen (Prinzipien 0.11.1 §21), und die
Reihenfolge der sieben Loops steht.
